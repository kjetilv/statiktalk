...
fun RapidsConnection.handle〔s.service〕(〔s.serviceCc〕: 〔s.service〕, vararg interestingKeys: String) =
    〔s.service〕ReceiveMediator(〔s.serviceCc〕).listenTo(this, interestingKeys.toList())
